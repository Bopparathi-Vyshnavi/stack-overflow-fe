                ...
                <form onSubmit={handleSubmit}>
                    <div className="ask-form-container">
                        ...
                        <label htmlFor="ask-ques-title">
                            <h4>Title</h4>
                            <p>Be specific and imagine you're asking to another person</p>
                            <input type="text" id='ask-ques-title' onChange={(e) => {setQuestionTitle(e.target.value)}} placeholder='e.g. Is there an R function for findingt the index of an element in a vector?' />
                        </label>
